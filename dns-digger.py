#!/usr/bin/env python3
"""
DNS Digger - Comprehensive DNS & Mail Record Lookup for offensive purposes.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DNS Digger v0.2 - Comprehensive DNS & Mail Record Lookup for offensive purposes",
